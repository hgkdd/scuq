...
# Modified for scuq, Hans Georg Krauthaeuser
"""
squc version
"""
...
def get_version(doreload=False):
    ...
    try:
        import scuq.__version__
        if doreload:
            reload(scuq.__version__)
        version = scuq.__version__.version
    except ImportError:
...
def write_version(version):
    ...
    if version == get_version():
        return
    directory = os.path.join(os.path.dirname(__file__), 'scuq')
