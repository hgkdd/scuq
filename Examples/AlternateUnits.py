...
try:
    myNewton = units.AlternateUnit("N", si.KILOGRAM*si.METER/si.SECOND**2)
except qexceptions.UnitExistsException, exp:
    # "The following base unit has already been defined : N"
    # ... you should not create units having the same symbol twice.
    print str(exp)
    
# Define the unit dynamic
myNewton = units.AlternateUnit("MN", si.KILOGRAM*si.METER/si.SECOND**2)
...
print "myNewton.is_compatible(si.NEWTON): "+str(myNewton.is_compatible(si.NEWTON))
